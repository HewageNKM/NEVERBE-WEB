...
import BrandTopUpFilter from "@/app/(site)/collections/brands/[brand]/components/BrandTopUpFilter";
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        selectedCategories.forEach((t) => params.append("tag", t));

        const res = await fetch(`/api/v1/products/brands/${brand}?${params}`);
    ...
    fetchProducts();
  }, [page, size, selectedCategories, inStock, selectedSort, brand, dispatch]);
    ...
    <section className="w-full max-w-[1440px] mx-auto px-4 md:px-8 pb-20 flex gap-12 pt-8">
      ...
      <div className="flex-1 w-full">
        ...
        {isLoading ? (
          ...
          <EmptyState heading={`No ${brand} products found`} />
        )}
