...
const ProductFAQ = () => {
  return (
    <section className="bg-surface-2 py-10 md:py-24 mt-10 md:mt-20 border-t border-default w-full">
      <div className="w-full max-w-[1600px] mx-auto px-4 md:px-10 lg:px-16">
        <h3 className="text-xl font-display font-black uppercase tracking-tighter text-primary mb-10 md:mb-16">
          FAQ
        </h3>
