...
import {resetFilter, setSelectedSizes, setSelectedType, toggleFilter} from "@/redux/manufacturerSlice/manufacturerSlice";
...
const ManufacturerPopUpFilter = () => {
    ...
    }, [selectedType, selectedSizes, dispatch, user, selectedSort]);
...
export default ManufacturerPopUpFilter;
