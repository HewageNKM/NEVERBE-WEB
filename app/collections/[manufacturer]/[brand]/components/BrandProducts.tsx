...
import { getItemsByTwoField, setProducts, setPage, setSelectedSort, toggleFilter } from "@/redux/brandSlice/brandSlice";
import { sortingOptions } from "@/constants";

const BrandProducts = ({ items, manufacturer, brand }: { items: any[], manufacturer: string, brand: string }) => {
  const dispatch: AppDispatch = useDispatch();
  const { products, page, size, selectedSort, isLoading, error } = useSelector((state: RootState) => state.brandSlice);
