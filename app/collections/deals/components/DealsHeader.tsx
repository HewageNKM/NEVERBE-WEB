...
const DealsHeader = () => {
  ...
  return (
    <section className="relative w-full overflow-hidden">
      ...
      >
        <h1 className="text-3xl md:text-5xl font-display font-bold tracking-wide text-white drop-shadow-md">
          {title}
        </h1>
        <p className="mt-2 text-gray-200 text-sm md:text-lg">
          Discover exclusive discounts and offers on your favorite brands!
        </p>
        <motion.div
